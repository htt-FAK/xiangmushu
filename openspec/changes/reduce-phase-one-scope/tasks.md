...
- [ ] 1.1 在 `openspec/changes/reduce-phase-one-scope/` 中补齐 proposal、design、tasks 与 capability 规格
- [ ] 1.2 在相关文档中统一一期定位为“知识库 + 锚点模板 + Word 初稿生成”
- [ ] 1.3 标注一期明确不承诺的内容：视觉审核、自动二轮优化、复杂模板自动识别、复杂版式全保真
...
- [ ] 8.1 更新首页文案，突出“一期是申报类 Word 初稿生成工具”
- [ ] 8.2 更新项目说明文档，加入锚点模板作为一期推荐模板规范
- [ ] 8.3 在开发文档中补充 `app.py` 收缩清单，标出需要移除、隐藏或改为实验入口的区块

### 8 完成判据

- [ ] 8.a 首页、项目说明和 OpenSpec 变更口径一致
- [ ] 8.b 新成员只读文档即可理解一期范围与非目标
- [ ] 8.c 后续实施者可以直接按文档定位 `app.py` 的收缩对象
