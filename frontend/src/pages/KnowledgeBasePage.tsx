      ...
      <div className="grid gap-6 xl:grid-cols-[390px_minmax(0,1fr)]">
          ...
          <Panel>
            ...
            <div className="space-y-3.5 md:space-y-4">
              <Field label={t("knowledge.target")}>
                <select
                  className="min-h-12 w-full border border-white/10 bg-night-950 px-3 text-sm text-white outline-none transition focus:border-signal-cyan/70"
                  value={selectedSlug}
        ...
        <Panel className="min-w-0">
          ...
          {uploadResults.length > 0 && (
            <div className="mb-6 border border-white/10 bg-night-950 p-4">
