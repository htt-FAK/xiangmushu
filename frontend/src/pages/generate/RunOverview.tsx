      ...
      <Panel className="min-w-0">
        {running && (
          <div className="mb-4 grid grid-cols-2 gap-2 sm:grid-cols-5">
            <StepIndicator currentStep={currentStep} step="retrieval" label={t("generate.stepRetrieval")} icon={<Database size={16} />} />
            <StepIndicator currentStep={currentStep} step="analysis" label={t("generate.stepAnalysis")} icon={<FileSearch size={16} />} />
            <StepIndicator currentStep={currentStep} step="generation" label={t("generate.stepGeneration")} icon={<PenTool size={16} />} />
            <StepIndicator currentStep={currentStep} step="audit" label={t("generate.stepAudit")} icon={<ShieldCheck size={16} />} />
            <StepIndicator currentStep={currentStep} step="done" label={t("generate.stepDone")} icon={<CheckCircle2 size={16} />} />
          </div>
        )}
